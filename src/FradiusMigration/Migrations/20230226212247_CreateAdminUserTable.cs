...
namespace FradiusMigration.Migrations
{
    ...
    public partial class CreateAdminUserTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            {
                Id = table.Column<int>(name: "admu_id", type:"INTEGER"),
                ...
                CreateAt = table.Column<DateTime>(name: "admu_create_at", type:"TIMESTAMP"),
                UpdateAt = table.Column<DateTime>(name: "admu_update_at", type:"TIMESTAMP"),
